...
namespace GMap.NET.WindowsForms.ToolTips
{
   ...
   public class GMapRoundedToolTip : GMapToolTip
   {
      ...
      public override void Draw(Graphics g)
      {
         ...
         System.Drawing.Rectangle rect = new System.Drawing.Rectangle(Marker.ToolTipOrigin.X, Marker.ToolTipOrigin.Y - st.Height, st.Width + TextPadding.Width * 2, st.Height + TextPadding.Height);
         rect.Offset(Offset.X, Offset.Y);

         g.DrawLine(Stroke, Marker.ToolTipOrigin.X, Marker.ToolTipOrigin.Y, rect.X + Radius/2, rect.Y + rect.Height - Radius/2);
